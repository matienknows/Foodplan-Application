...
class MeattableEditComponent extends Component{
    ...
    componentDidMount(){
       ...
       FoodDataService.retrieveItemMeat(this.state.id)
       .then(
    ...
    onSubmit(values){
        ...
        if(this.state.id === -1){    
            FoodDataService.createMeatItem(meatItem)
            .then(() => this.props.history.push("/configFoodTable"))
            alert("Das Gericht mit Fleisch wurde erstellt") 
            return
        }else{
            FoodDataService.updateMeatItem(this.state.id, meatItem)
            .then(() => this.props.history.push("/configFoodTable"))
    ...
    render(){
        ...
        return(
            <div>
            <h1>Fleischgerichtsplan bearbeiten</h1>
...
export default MeattableEditComponent